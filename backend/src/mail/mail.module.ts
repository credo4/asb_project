...
import { EmailDeliveriesController } from './email-deliveries.controller';
...
@Module({
  ...
  providers: [MailService, EmailDeliveriesService],
  exports: [MailService, EmailDeliveriesService],
})
